...
struct_declarator_list
	: struct_declarator																{$$=$1;}
	| struct_declarator COMMA struct_declarator				{$$=linkDeclaratorList($1,$3);}
...
equality_expression
	...
	| relational_expression EQL additive_expression					{$$=makeNode(N_EXP_EQL,$1,NIL,$3);}
	| relational_expression NEQ additive_expression					{$$=makeNode(N_EXP_NEQ,$1,NIL,$3);}
